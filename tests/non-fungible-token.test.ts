...
describe('Non-Fungible Token', () => {
  ...
  it(
    ...
    async () => {
      ...
      const history = await session.getTransferHistoryByAccount(session.account.id, null, 1, null);
  ...
  it(
    ...
    async () => {
      ...
      const historySender = await session.getTransferHistoryByAccount(session.account.id, null, 1, null);
      ...
      const historyReceiver = await session.getTransferHistoryByAccount(session2.account.id, null, 1, null);
